...
determine whether you can transform str1 into str2
by doing zero or more conversions.

In one conversion you can convert all occurrences of
one character in str1 to any other lowercase English character.
...
var canConvert = function (str1, str2) {
  ...
  for (let i = 0; i < str1.length; i++) {
    if (map[str1[i]] && map[str1[i]] != str2[i]) return false
    map[str1[i]] = str2[i]
    letters.add(str2[i])
  }
