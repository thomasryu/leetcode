...
var findRelativeRanks = function (score) {
  ...
  sorted[0] && (labels[sorted[0]] = 'Gold Medal')
  sorted[1] && (labels[sorted[1]] = 'Silver Medal')
  sorted[2] && (labels[sorted[2]] = 'Bronze Medal')

  for (let i = 3; i < sorted.length; i++) labels[sorted[i]] = i + 1 + ''

  return score.map((s) => labels[s])
}
