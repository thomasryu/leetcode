...
StockSpanner.prototype.next = function (price) {
  let top = this.stocks.length - 1
  while (top >= 0 && this.stocks[top] <= price) top--
  this.stocks.push(price)
  return this.stocks.length - 1 - top
}

// Optimized solution
var StockSpanner = function () {
  // stocks store an array [price, span]
  this.stocks = []
}
...
StockSpanner.prototype.next = function (price) {
  ...
  while (stocks.length && stocks.at(-1)[0] <= price) span += stocks.pop()[1]
